...
public class TutorialTextRepository {
    ...
    private const string TEXT_MOVEMENT_TUTORIAL = "Этот уровень линейный. На таких уровнях кораблик движется под воздействием течения, а ты можешь корректировать его курс, ускорять или замедлять. Проведи мышкой с зажатой левой кнопкой мыши в нужном направлении через кораблик, после чего отпусти левую кнопку.";
