...
public class PopupTextRepository {
    ...
    private const string TEXT_STATIC_OBSTACLE_TUTORIAL = "На каждом уровне есть препятствия. Столнувшись с ним, тебе придётся начать уровень заново или потратить ценные монетки. Сейчас ты можешь двигаться дальше, но постарайся больше не сталкиваться с ними)";
    private const string TEXT_FLOATABLE_OBSTACLE_TUTORIAL = "На каждом уровне есть препятствия. Столнувшись с ним, тебе придётся начать уровень заново или потратить ценные монетки. Сейчас ты можешь двигаться дальше, но постарайся больше не сталкиваться с ними)";
    private const string TEXT_BREAKABLE_OBSTACLE_TUTORIAL = "На каждом уровне есть препятствия. Столнувшись с ним, тебе придётся начать уровень заново или потратить ценные монетки. Сейчас ты можешь двигаться дальше, но постарайся больше не сталкиваться с ними)";
    private const string TEXT_MATCHABLE_OBSTACLE_TUTORIAL = "На каждом уровне есть препятствия. Столнувшись с ним, тебе придётся начать уровень заново или потратить ценные монетки. Сейчас ты можешь двигаться дальше, но постарайся больше не сталкиваться с ними)";
